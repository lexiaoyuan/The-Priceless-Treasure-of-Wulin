...
![Linux的目录结构](noteImage/DovL3N0YXRpYzIuaW9jb2Rlci5jbi81YzJmNTRmMjhkNGVhYmJlMTM4ZmQ4.png)
...
![](noteImage/20200229173922281.png)
...
一般是文件过大造成的，可以先用**df -h**查看一下是哪个地方占用较大，其次**du -h --max-depth=1**查询具体文件夹占用大小，以此类推，查出实际占用大的文件删除。**ls -lhS**文件大小排序查看。
...
Linux 支持 5 种文件类型，如下图所示：<img src="noteImage/aHR0cDovL3N0YXRpYzIuaW9jb2Rlci5jbi9iN.png" alt="文件类型" style="zoom:67%;" />
...
![](noteImage/20210208173309353.png)
...
![](noteImage/20210208173328630.png)
...
![](noteImage/20210208173411890.png)
...
![](noteImage/20210208173546831.png)
...
![](noteImage/20210208173619594.png)
...
![](noteImage/20210208173641934.png)

**实例分析**

![](noteImage/20210208173658623.png)

上面看到磁盘每秒传输次数平均约为400；每秒读取约5M，写入约1M

![](noteImage/20210208173730943.png)

**sar**

命令行输入sar：

![](noteImage/20210208173752651.png)
